<template>
    <div>
        <div v-for="loc, i in locations" class="flex">
            <InputGroup class="w-full"  v-model="loc.Name" name="loc" prettyname="loc" :compact="true" /> 
            <TheButton  class="w-1/5 my-2" @click="saveLocation(i)" >Save</TheButton>
        </div>
        <div class="flex" >
            <InputGroup class="w-full"  v-model="addLocations.Name" name="loc" prettyname="loc" :compact="true" /> 
